...
func defaultConfig() config {
	return config{
		...
		DefaultTopicMode: TopicModeCore,
...
func WithDefaultTopicMode(m TopicMode) Option { return func(c *config) { c.DefaultTopicMode = m } }

// WithDefaultCodec overrides the default codec (JSON by default).
func WithDefaultCodec(cd Codec) Option { return func(c *config) { c.DefaultCodec = cd } }
